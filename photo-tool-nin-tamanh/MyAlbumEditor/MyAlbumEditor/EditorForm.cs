...
namespace MyAlbumEditor
{
    public partial class EditorForm : Form
    {
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            string msg;
            if (count == 1)
                msg = "Do you really want to remove the selected photograp?";
            else
                msg = string.Format("Do you really want to remove the {0} selected photograp? ", count);
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            ...
            {
                dlg.Description = " Select an album file directory to add the dialog.";
        ...
        private void UpdateTabs()
        {
            ...
            if (nullManager)
                Text = "Selected album could not be epened";
            else
